        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div class="about-thumbnails">
                    <div class="thumbnail">
                        <img src="{{ asset('assets/images/product/IMG_4380.jpg') }}" alt="corporate_business" width="410" height="490">

                        <div class="image-two">
                            <div style="height: 50px;">
                                <!-- Contenu ici -->
                            </div>
                            <img src="{{ asset('assets/images/product/aceuil1.jpg') }}" alt="corporate_business" width="200" height="820">
                        </div>

                        <div class="image-three animated">
                            <img class="" src="{{ asset('assets/images/product/slider.jpg') }}" alt="corporate_business" width="410" height="190">
            ...
            <div class="col-lg-6">
                <div class="about-inner">
                    <div class="section-head text-align-left section-head-one-side">
                        ...
                        <h2 class="title split-collab text-justify">Découvrez-en plus sur notre <br>Louda Burkina Faso</h2>
                    </div>

                    <p class="description text-justify" data-sal-delay="200" data-sal="slide-up" data-sal-duration="800">
                        Louda Burkina Faso est une entreprise spécialisée dans la fourniture de biens et services dans les secteurs des mines, de la transformation, du BTP, de l’énergie et des infrastructures en Afrique. Fort de son expertise et de son engagement envers l'excellence, Louda Burkina Faso accompagne ses partenaires à chaque étape de leurs projets en leur proposant des solutions sur mesure, innovantes et adaptées aux réalités locales. Grâce à une équipe expérimentée et un réseau stratégique, le groupe contribue activement au développement durable et à la croissance économique du continent africain.
                    </p>
