...
@section('content')
 ...
 <!-- tpm-header-area start -->
    ...
    <div class="breadcrumb-area bg_image tmp-section-gap breadcrumb-bg position-relative" style="background-image: url('{{ asset('assets/images/product/Image_fx (3).jpg') }}'); background-size: cover; background-position: center; min-height: 550px;">
        <!-- Surcouche opaque -->
    ...
    ">
        <ul class="list-inline m-0">
            ...
            <li class="list-inline-item text-white">
                ...
                <a href="{{ route('notre_group') }}" class="text-white text-decoration-none">LOUDA CHEMICAL</a>
            </li>
        </ul>
    </div>
                ...
                <div class="col-lg-12">
                    <div class="section-head">
                        <div class="section-sub-title center-title">
                            ...
                            <span class="subtitle">PRODUIT DE LOUDA CHEMICAL</span>
                        </div>
                        <h2 class="title split-collab">Explorez l’excellence de notre gamme de produits </h2>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    ...
                                    <div class="signle-product-start" data-tmp-cursor="lg text-secondary transparent fw-bold" data-tmp-cursor-icon="fa-solid fa-arrow-up-right">
                                        ...
                                        <img src="{{ asset('assets/images/product/RECO FÉVRIER LOUDA.png') }}" alt="corporate_business">

                                        <div class="inner-content">
                                            <h5 class="title">Exportation de matières premières agricoles</h5>
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="signle-product-start" data-tmp-cursor="lg text-secondary transparent fw-bold" data-tmp-cursor-icon="fa-solid fa-arrow-up-right">
                                        ...
                                        <div class="inner-content">
                                            <h5 class="title">Importation d’équipements industriels</h5>
                                            <span class="designation"></span>
                                            <div class="tag"></div>
                                        </div>
                                    </div>
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="signle-product-start" data-tmp-cursor="lg text-secondary transparent fw-bold" data-tmp-cursor-icon="fa-solid fa-arrow-up-right">
                                        ...
                                        <div class="inner-content">
                                            <h5 class="title">Courtier dans l’achat de matériaux de construction</h5>
                                            <span class="designation"></span>
                                            <div class="tag"></div>
                                        </div>
                                    </div>
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="signle-product-start" data-tmp-cursor="lg text-secondary transparent fw-bold" data-tmp-cursor-icon="fa-solid fa-arrow-up-right">
                                        ...
                                        <div class="inner-content">
                                            <h5 class="title">Création d’un réseau de distribution local</h5>
                                            <span class="designation"></span>
                                            <div class="tag"></div>
                                        </div>
                                    </div>
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="signle-product-start" data-tmp-cursor="lg text-secondary transparent fw-bold" data-tmp-cursor-icon="fa-solid fa-arrow-up-right">
                                        ...
                                        <div class="inner-content">
                                            <h5 class="title">Accompagnement administratif en douane et logistique</h5>
                                            <span class="designation"></span>
                                            <div class="tag"></div>
                                        </div>
                                    </div>
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="signle-product-start" data-tmp-cursor="lg text-secondary transparent fw-bold" data-tmp-cursor-icon="fa-solid fa-arrow-up-right">
                                        ...
                                        <div class="inner-content">
                                            <h5 class="title"> Participation à des foires et salons internationaux</h5>
                                            <span class="designation"></span>
                                            <div class="tag"></div>
                                        </div>
                                    </div>
