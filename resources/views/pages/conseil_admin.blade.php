    ...
    ">
        <ul class="list-inline m-0">
            ...
            <li class="list-inline-item text-white">
                ...
                <a href="{{ route('notre_group') }}" class="text-white text-decoration-none">CONSEIL D'ADMINISTRATION</a>
            </li>
        </ul>
    </div>
            ...
            <div class="row">
                <div class="col-lg-12" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                    <div class="section-head">
                        ...
                        <h2 class="title split-collab">Membres du Conseil d'Administration de Louda</h2>
                    </div>
                </div>
            </div>
            <div class="row g-5">
