        ...
        <div class="swiper swiper-startup-banner-construction">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    ...
                    <div class="tmp-banner-area banner-style-five inconstruction tmp-section-gap banner-bg-construction bg-bf bg_image">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="banner-startup-main-content-wrapper">
                                        ...
                                        <p class="disc">
                                            Avec Louda Burkina Faso, connectez vos ambitions au monde : développez vos opportunités, exportez vos richesses, et propulsez votre entreprise vers de nouveaux horizons.
                                        </p>
