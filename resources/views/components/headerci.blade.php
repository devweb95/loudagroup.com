                ...
                <div class="col-lg-12">
                    <div class="header-top-inner">
                        <div class="left-information-area">
                            <p class="left-top">
                                <a href="mailto:procurementci@loudagroup.com" class="text-[#2170b8]">
                                  <i class="fa-regular fa-envelope"></i> procurementci@loudagroup.com
                                </a>
                              </p>
                        ...
                        <div class="right-header-top">
                            <div class="social-area-transparent">
                                ...
                                <a href="https://web.facebook.com/profile.php?id=61568311355191"><i class="fa-brands fa-facebook-f"></i></a>
                                <a href="https://www.linkedin.com/company/105432335/admin/dashboard/"><i class="fa-brands fa-linkedin-in"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-12">
                <div class="header-mida-area style-two ">
                    ...
                    <div class="actions-area">
                        ...
                        <a href="mailto:procurementci@loudagroup.com" class="tmp-btn btn-primary">Obtenir Un Devis</a>
