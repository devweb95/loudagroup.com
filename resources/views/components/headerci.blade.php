                ...
                <div class="col-lg-12">
                    <div class="header-top-inner">
                        <div class="left-information-area">
                            <p class="left-top">
                                <a href="mailto:contactci@loudagroup.com" class="text-[#2170b8]">
                                  <i class="fa-regular fa-envelope"></i> contactci@loudagroup.com
                                </a>
                              </p>
            ...
            <div class="col-lg-12">
                <div class="header-mida-area style-two ">
                    ...
                    <div class="actions-area">
                        ...
                        <a href="mailto:contactci@loudagroup.com" class="tmp-btn btn-primary">Obtenir Un Devis</a>
