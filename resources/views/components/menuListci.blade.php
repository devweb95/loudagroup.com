<nav class="main-nav">
    <ul class="parent-nav">
        ...
        <li class="has-dropdown">
            ...
            <ul class="submenu">
                <li><a href="{{ route('notre_group_ci') }}">Notre Groupe</a></li>
                <li><a href="{{ route('objectif_ci') }}">Nos Valeurs</a></li>
                <!--<li><a href="{{ route('nos-entreprise') }}">Nos entreprises</a></li>-->
                <li><a href="{{ route('direction_ci') }}">Direction</a></li>
        ...
        <li class="has-dropdown">
            ...
            <ul class="submenu">
                <li><a href="{{ route('louda_chimical_ci') }}">Louda Chemical</a></li>
                <li><a href="{{ route('louda_industry_ci') }}">Louda Industry</a></li>
                <li><a href="{{ route('louda_service_ci') }}">Louda Services</a></li>
                
            </ul>
        </li>

        <li>
            <a class="nav-link" href="{{ route('actualite_ci') }}">
                <span class="rolling-text">ACTUALITÉ</span>
            </a>
        </li>
        <li>
            <a class="nav-link" href="{{ route('offre_emploie_ci') }}">
        ...
        <li>
            <a class="nav-link" href="{{ route('contact_ci') }}">
