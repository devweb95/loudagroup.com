<nav class="main-nav">
    <ul class="parent-nav">
        ...
        <li class="has-dropdown">
            ...
            <ul class="submenu">
                <li><a href="{{ route('notre_group_bf') }}">Notre Groupe</a></li>
                <li><a href="{{ route('objectif_bf') }}">Nos Valeurs</a></li>
                <!--<li><a href="{{ route('nos-entreprise') }}">Nos entreprises</a></li>-->
                <li><a href="{{ route('direction_bf') }}">Direction</a></li>
        ...
        <li class="has-dropdown">
            ...
            <ul class="submenu">
                <li><a href="{{ route('louda_chimical_bf') }}">Louda Chemical</a></li>
                <li><a href="{{ route('louda_industry_bf') }}">Louda Industry</a></li>
                <li><a href="{{ route('louda_service_bf') }}">Louda Services</a></li>
                
            </ul>
        </li>

        <li>
            <a class="nav-link" href="{{ route('actualite_bf') }}">
                <span class="rolling-text">ACTUALITÉ</span>
            </a>
        </li>
        <li>
            <a class="nav-link" href="{{ route('offre_emploie_bf') }}">
        ...
        <li>
            <a class="nav-link" href="{{ route('contact_bf') }}">
